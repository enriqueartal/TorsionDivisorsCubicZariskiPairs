...
RUN mkdir -p ${HOME}/9torsion
COPY 9torsion/*.ipynb ${HOME}/9torsion/
RUN mkdir -p ${HOME}/ExistenceOfCurves
COPY 9torsion/*.ipynb ${HOME}/ExistenceOfCurves/
RUN mkdir -p ${HOME}/Triangles
COPY Triangles/*.ipynb ${HOME}/Triangles/
